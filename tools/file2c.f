...
: usage
  "Usage: file2c [-b] VARNAME SRC [OUT]" panic
;
...
: parse-opt
  opt:read! 0usage
  dup "-b" s= [ yes is-bytes! opt:read! 0usage ] when
  s:put var-name!
...
: type is-bytes [ "uint8_t" ] [ "char" ] if ;


: header ( -- )
  "/* This file is generated by " pr src pr
  ". DO NOT EDIT */" prn cr
  type pr space var-name pr "[] = {" pr
;
...
: footer ( -- )
  is-bytes [ "0x00" pr ] unless  # put null termination
  cr "};" prn
;
